...
import mk.finki.ukim.mk.lab.repository.jpa.EventRepositoryInt;
import mk.finki.ukim.mk.lab.repository.jpa.LocationRepositoryInt;
...
public class EventServiceImpl implements EventService {
    private final EventRepositoryInt eventRepository;
    private final LocationRepositoryInt locationRepository;

    public EventServiceImpl(EventRepositoryInt eventRepository, LocationRepositoryInt locationRepository) {
